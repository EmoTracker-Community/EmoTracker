...
{
    public class NwaProviderOption : ObservableObject, IProviderOption
    {
        string mKey;
        string mDisplayName;
        ...
        public NwaProviderOption(string key, string displayName, ProviderOptionKind kind, object defaultValue, List<object> availableValues)
        {
            mKey = key;
