...
{
    public partial class UpdateAvailableWindow : Window, IUpdateAvailable, IReleaseNotesDisplayer
    {
        // ── IUpdateAvailable ───────────────────────────────────────────────────
        ...
        public UpdateAvailableWindow(List<AppCastItem> updates, string currentVersion, string appName)
            : this()
        {
